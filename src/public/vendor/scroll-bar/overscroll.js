! function(t, e) {
    ...
    return function(t) {
        ...
        function a(t) {
            return null == t ? void 0 === t ? N : C : B && B in Object(t) ? S(t) : A(t)
        }
        ...
        function u(t) {
            return "symbol" == typeof t || L(t) && z(t) == U
        }
        ...
        function h(t) {
            ...
            t = t.replace(Y, "");
            var o = R.test(t);
            return o || $.test(t) ? I(t.slice(2), o ? 2 : 8) : q.test(t) ? X : +t
        }

        function f(t, e, o) {
            return void 0 === o && (o = e, e = void 0), void 0 !== o && (o = D(o), o = o === o ? o : 0), void 0 !== e && (e = D(e), e = e === e ? e : 0), y(D(t), e, o)
        }
        ...
        function p(t, e, o) {
            function r(e) {
                var o = f,
                    r = p;
                return f = p = void 0, m = e, v = t.apply(r, o)
            }

            function n(t) {
                return m = t, _ = setTimeout(c, e), x ? r(t) : v
            }
            ...
            function l() {
                void 0 !== _ && clearTimeout(_), m = 0, f = y = p = _ = void 0
            }

            function u() {
                return void 0 === _ ? v : a(J())
            }
            ...
            return e = D(e) || 0, b(o) && (x = !!o.leading, g = "maxWait" in o, d = g ? Q(D(o.maxWait) || 0, e) : d, O = "trailing" in o ? !!o.trailing : O), h.cancel = l, h.flush = u, h
        }

        function d(t) {
            var e = {};
            return Object.keys(t).forEach(function(o) {
                if (!ot.test(o)) return void(e[o] = t[o]);
                var r = t[o];
                o = o.replace(/^-/, ""), e[o] = r, et.forEach(function(t) {
                    e["-" + t + "-" + o] = r
                })
            }), e
        }
        ...
        instanceof Array && function(t, e) {
        ...
        }, y = (Object.assign, n), b = i, m = o(2), x = "object" == typeof self && self && self.Object === Object && self, g = m.a || x || Function("return this")(), O = g, w = O.Symbol, j = w, k = Object.prototype, M = k.hasOwnProperty, E = k.toString, P = j ? j.toStringTag : void 0, S = s, T = Object.prototype, W = T.toString, A = c, C = "[object Null]", N = "[object Undefined]", B = j ? j.toStringTag : void 0, z = a, L = l, U = "[object Symbol]", G = u, X = NaN, Y = /^\s+|\s+$/g, q = /^[-+]0x[0-9a-f]+$/i, R = /^0b[01]+$/i, $ = /^0o[0-7]+$/i, I = parseInt, D = h, F = f, H = function() {
            return O.Date.now()
        }, J = H, K = "Expected a function", Q = Math.max, V = Math.min, Z = p, tt = o(4), et = ["webkit", "moz", "ms", "o"], ot = new RegExp("^-(?!(?:" + et.join("|") + ")-)"), rt = function() {
            function t(t) {
                this._scrollbar = t
            }
            return t.prototype.render = function(t) {
                var e = t.x,
                    ...
                    a = i.offset;
                if (v(i.contentEl, {
                        "-transform": "translate3d(" + -(a.x + o) + "px, " + -(a.y + n) + "px, 0)"
                    }), o) {
                    c.xAxis.show();
                    var l = s.container.width / (s.container.width + Math.abs(o));
                    v(c.xAxis.thumb.element, {
                        "-transform": "translate3d(" + c.xAxis.thumb.offset + "px, 0, 0) scale3d(" + l + ", 1, 1)",
                        "-transform-origin": o < 0 ? "left" : "right"
                    })
                }
                if (n) {
                    c.yAxis.show();
                    var l = s.container.height / (s.container.height + Math.abs(n));
                    v(c.yAxis.thumb.element, {
                        "-transform": "translate3d(0, " + c.yAxis.thumb.offset + "px, 0) scale3d(1, " + l + ", 1)",
            ...
            return t.prototype.mount = function() {
                ...
                var o = t.x,
                    ...
                    n = t.y,
                    i = void 0 === n ? 0 : n;
                if (!r && !i) return void v(this._canvas, {
                    display: "none"
                });
                v(this._canvas, {
                    display: "block"
                ...
                var c = F(Math.abs(t) / o, 0, .75),
                    a = F(c, 0, .25) * n,
                    l = Math.abs(t),
                    u = this._touchY || i / 2;
                s.globalAlpha = c, s.beginPath(), s.moveTo(0, -a), s.quadraticCurveTo(l, u, 0, i + a), s.fill(), s.closePath(), s.restore()
                ...
                var c = F(Math.abs(t) / o, 0, .75),
                    ...
                    l = this._touchX || n / 2,
                    u = Math.abs(t);
                s.globalAlpha = c, s.beginPath(), s.moveTo(-a, 0), s.quadraticCurveTo(l, u, n + a, 0), s.fill(), s.closePath(), s.restore()
            }, t
        }();
        ...
        var st = /wheel|touch/,
            ct = function(t) {
                function e() {
                    ...
                    return e._glow = new nt(e.scrollbar), e._bounce = new rt(e.scrollbar), e._wheelScrollBack = {
                        x: !1,
                        y: !1
                    }, e._lockWheel = {
                        x: !1,
                ...
                return r(e, t), Object.defineProperty(e.prototype, "_isWheelLocked", {
                    ...
                    Object.defineProperty(o, "effect", {
                        ...
                        set: function(t) {
                            ...
                            if (t !== it.BOUNCE && t !== it.GLOW) throw new TypeError("unknow overscroll effect: " + t);
                            n = t, r.options.continuousScrolling = !1, t === it.GLOW ? (e.mount(), e.adjust()) : e.unmount()
                        }
                    }), o.effect = n
                }, e.prototype.onUpdate = function() {
                    this.options.effect === it.GLOW && this._glow.adjust()
                    ...
                    if (this._lastEventType = e.type, !this._enabled || !st.test(e.type)) return t;
                    ...
                    if (!e) return !1;
                    if (this._amplitude[t]) return !0;
                    var o = this.scrollbar.offset[t],
                        r = this.scrollbar.limit[t];
                    return 0 !== r && (F(o + e, 0, r) === o && (0 === o || o === r))
                }, e.prototype._absorbMomentum = function(t, e) {
                    var o = this,
                        r = o.options,
                        n = o._lastEventType,
                        i = o._amplitude;
                    st.test(n) && (i[t] = F(e, -r.maxOverscroll, r.maxOverscroll))
                    ...
                    var o, r = this,
                        ...
                        a = s[t],
                        l = e * a < 0;
                    o = l ? 0 : this._wheelScrollBack[t] ? 1 : Math.abs(a / n.maxOverscroll);
                    var u = a + e * (1 - o);
                    s[t] = 0 === i.offset[t] ? F(u, -n.maxOverscroll, 0) : F(u, 0, n.maxOverscroll), l && (c[t] = s[t])
