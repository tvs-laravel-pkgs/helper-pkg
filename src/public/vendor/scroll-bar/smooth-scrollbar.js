    ...
    return function(t) {
        ...
        function k(t, n, e) {
            ...
            if (n && d.contains(n)) {
                ...
                c && t.isVisible(n) || t.setMomentum(y.left - v.left - l, i ? y.top - v.top - a : y.bottom - v.bottom - h)
            }
        }
        ...
        function F(t) {
            ...
            r(window, "mousemove", function(r) {
                ...
                t.stopPropagation(), cancelAnimationFrame(e), s = !0, E(document.body, {
                    "-user-select": "none"
                }), E(o, {
                    "-user-select": "auto"
                })
            }), r(window, "mouseup blur", function() {
                cancelAnimationFrame(e), s = !1, E(document.body, {
                    "-user-select": ""
                }), E(o, {
                    "-user-select": ""
                })
        ...
        }(), Lt = new WeakMap, Nt = ["webkit", "moz", "ms", "o"], zt = new RegExp("^-(?!(?:" + Nt.join("|") + ")-)"), Ct = function() {
            function t(t) {
        ...
        var tn = function(t) {
            ...
            return r(n, t), n.init = function(t, n) {
                ...
                return V()
            }, n.version = "8.2.5", n.ScrollbarPlugin = Bt, n
        }($t);
        n.default = tn
    }, function(t, n, e) {
