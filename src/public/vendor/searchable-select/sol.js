    ...
    SearchableOptionList.prototype = {
            ...
            events: {
                ...
                onScroll: function () {
                    ...
                    this.$selectionContainer
                        ...
                        .css('right', Math.floor(this.$container.offset().right))
        ...
        _renderOption: function (solOption, $optionalTargetContainer) {
            ...
            if (this.config.multiple) {
                ...
                $inputElement = $('<input type="checkbox" class="sol-checkbox color-none" id="color-set'+solOption.indx+'"/>');
        ...
        _addSelectionDisplayItem: function ($changedItem) {
            var change_class = $changedItem[0].id;
            ...
            if (!$existingDisplayItem) {
                ...
                $existingDisplayItem = $('<div class="sol-selected-display-item '+change_class+'"/>')
