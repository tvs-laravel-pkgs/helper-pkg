...
(function($, window, document, undefined) {
    ...
    $.fn.imageuploadify = function(opts) {
        ...
        this.each(function() {
            ...
            let totalFiles = [];
            let counter = 0;
            let dragbox = $(`<div class="imageuploadify well"><div class="imageuploadify-overlay"><i class="fa fa-picture-o"></i></div><div class="imageuploadify-images-list text-center"><i class="fa fa-cloud-upload"></i><button type="button"class="btn btn-default"><span class='imageuploadify-attach-text'>Attach Files</span></button></div></div>`);
            ...
            const readingFile = (id, file) => {
                ...
                let container = $(`<div class='imageuploadify-container'><button type='button'class='btn btn-danger glyphicon glyphicon-remove'></button><div class='imageuploadify-details'><div class='imageuploadify-file-icon'></div><span class='imageuploadify-file-name'>${file.name}</span><span class='imageuploadify-file-type'>${file.type}</span><span class='imageuploadify-file-size'>${file.size}</span></div></div>`);
